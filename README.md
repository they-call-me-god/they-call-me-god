...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=30&duration=3500&pause=1000&color=6366F1&center=true&vCenter=true&width=720&lines=Hey+%F0%9F%91%8B+I'm+Shaur;I+build+autonomous+AI+systems;AI+that+survives+contact+with+reality;Voice+agents+%C2%B7+Self-learning+web+%C2%B7+Cron+pipelines" alt="Typing SVG" />

<br/>

> **Founder-engineer building AI that runs real businesses — not demos.**
> Voice agents, self-improving web, and pipelines that ship without me.
> _Click any repo. Every claim verifies._
...
```python
shaur = {
    "role":      "Founder-engineer — Full-Stack + AI",
    "based":     "Jaipur, India 🇮🇳",
    "building":  "autonomous systems that run real businesses",
    "live":      ["AI voice receptionists for real Jaipur clinics",
                  "a portfolio that rewrites & redeploys itself nightly",
                  "content pipelines that post without me"],
    "stack":     ["Next.js", "TypeScript", "Python", "Claude API", "VAPI", "n8n"],
    "ethos":     "ship it, then make it learn",
    "rule":      "click any claim to verify",
}
```
...
![VAPI](https://img.shields.io/badge/VAPI_Voice_AI-10b981?style=for-the-badge&logo=audiomack&logoColor=white)

**Infra, Data & Automation**
![Vercel](https://img.shields.io/badge/Vercel-000000?style=for-the-badge&logo=vercel&logoColor=white)
![Postgres](https://img.shields.io/badge/Neon_Postgres-00E5CC?style=for-the-badge&logo=postgresql&logoColor=white)
...
> Everything here is in this account. Open the code.
...
[![🌐 Live Portfolio](https://img.shields.io/badge/🌐_See_it_live-Open_Portfolio-6366f1?style=for-the-badge&logoColor=white)](https://portfolio-iota-nine-97gumluwra.vercel.app)
...
<!--PULSE:START-->
**Thursday, 04 Jun 2026** &nbsp;•&nbsp; Day 155 of 2026

> _Make it work, make it think, make it teach itself._
